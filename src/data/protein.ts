  ...
  charts: {
    ...
    growthPie: {
      ...
      series: [{
        ...
        color: '#059669',
        points: [
          { label: 'RiteBite', value: 24, color: '#f59e0b' },
          { label: 'Yoga Bar', value: 18, color: '#059669' },
          { label: 'MuscleBlaze', value: 32, color: '#dc2626' },
          { label: 'Nutrilite', value: 15, color: '#065f46' },
        ],
      }],
    ...
    pricingPie: {
      ...
      series: [{
        ...
        color: '#0ea5e9',
        points: [
          { label: 'RiteBite', value: 149, color: '#0ea5e9' },
          { label: 'Yoga Bar', value: 99, color: '#059669' },
          { label: 'MuscleBlaze', value: 1499, color: '#6b7280' },
          { label: 'Nutrilite', value: 2199, color: '#f43f5e' },
        ],
      }],
    ...
    featureAdoptionPie: {
      ...
      series: [{
        ...
        color: '#8b5cf6',
        points: [
          { label: 'Clean label (Yoga Bar)', value: 92, color: '#0ea5e9' },
          { label: 'Variety pack (RiteBite)', value: 72, color: '#059669' },
          { label: 'Variety pack (Yoga Bar)', value: 65, color: '#f59e0b' },
          { label: 'Plant option (MuscleBlaze)', value: 22, color: '#f43f5e' },
        ],
      }],
